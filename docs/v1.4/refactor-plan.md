...
| W1-INT | Lead-owned shared schema/API integration | W1-* contracts | Lead | integration | IN_PROGRESS | High | All Wave 1 schemas done; Context service and Project/Capability read paths pending. |
