...
from career_harness.api.outcome_insights import OutcomeInsightApi, create_outcome_insight_router
...
def create_app(
    ...
    *,
    ...
    if outcome_insight_api is not None:
        app.include_router(create_outcome_insight_router(outcome_insight_api))
