...
| W2-MATCH-PERSIST | Durable Match/Gap persistence and exact input resolver | W2-MATCH | Lead | integration | READY | High | Exact frozen refs replay; additive migration only after contract freeze. |
