...
| W1-INT | Lead-owned shared schema/API integration | W1-* contracts | Lead | integration | IN_PROGRESS | High | Opportunity, Capability and Project schemas done; Context schema pending. |
