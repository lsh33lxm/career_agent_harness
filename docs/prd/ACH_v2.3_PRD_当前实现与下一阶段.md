...
| G3 Resume Studio | 部分完成 | 校验、导出、渲染、ATS、文本/PDF fallback 导入、用户恢复点、基础版本历史查看和追加式旧版本恢复已实现；图片 OCR、字段级 undo/redo 和完整差异 UI 未完成 |
...
- 前端：23 个测试文件、65 项测试通过；`npm run build` 通过。
