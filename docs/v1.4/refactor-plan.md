...
| W1-INT | Lead-owned shared schema/API integration | W1-* contracts | Lead | integration | IN_PROGRESS | High | Opportunity schema + atomic admission done; priorities/API and remaining schemas pending. |
