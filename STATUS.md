...
- G5 知识治理：**PARTIAL**。Memory 来源亲和度与 consolidation proposal、SourceConnector schedule metadata、有界运行、认证 MCP transport boundary 和 JSON-RPC stdio 适配器已实现；SSE/生产认证接入、常驻 dispatcher 和完整 CLI sandbox 仍待补齐。
