...
def preserve_validated_resume_json(content: dict[str, Any]) -> dict[str, Any]:
    """Validate resume content while preserving its forward-compatible JSON shape."""
    ResumeData.model_validate(content)
    return content.copy()
